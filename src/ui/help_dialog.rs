...
const HELP_SECTIONS: &[(&str, &[(&str, &str)])] = &[
    ...
    (
        ...
        &[
            ...
            ("Home / End", "Jump to top / bottom"),
            ("Enter / F4", "Open file in editor at match line"),
            ("Right", "Expand file matches"),
            ("Left", "Collapse file / jump to parent"),
            ("Type chars", "Filter results by text or filename"),
            ("Backspace", "Edit filter"),
            ("Tab / Shift+Tab", "Switch panel"),
            ("Esc", "Clear filter / close search results"),
        ],
    ),
    (
    ...
    (
        ...
        &[
            ...
            ("PageUp / PageDown", "Page through file"),
    ...
    (
        "Parquet Viewer",
        &[
            ("Up / Down", "Move row cursor (or expand/collapse in tree)"),
            ("Left / Right", "Move column cursor / expand tree"),
            ("Shift+Left / Shift+Right", "Page columns by one screen"),
            ("Enter", "Open cell detail popup (or expand tree node)"),
            ("Shift+Enter", "Open full row detail popup"),
            ...
            ("g", "Go to row"),
            ("/", "Search (regex, case-insensitive, works in tree too)"),
            ("n / N", "Next / previous match (wraps at ends)"),
            (
                "* / #",
            ...
            (
                "s",
                "Sort loaded window by current column (none → asc → desc)",
            ),
            (
                "y / Y / c / j",
                "Copy cell / row TSV / column values / row as JSON",
            ),
            ("f", "Freeze / unfreeze current column (pin when scrolling)"),
            ("h / H", "Hide current column / unhide all"),
            ("Space", "Toggle row selection"),
            ("a", "Clear row selection"),
            (
                "Ctrl+A / Ctrl+I",
                "Select all rows / invert selection (≤ 1M rows)",
            ),
            (
                "w / W / = / ~",
                "Widen / narrow / reset all / autofit current column",
            ),
            ("^ / $", "Jump to first / last visible column"),
            (
                "i",
                "Column info popup (type, sizes, encodings per row group)",
            ),
            (
                "R",
                "Reload file from disk (preserves cursor, widths, selection)",
            ),
            (
                ",",
                "Toggle thousands separators for integer columns (display only)",
            ),
            ("Mouse click", "Jump row & column cursor to clicked cell"),
            ("Mouse wheel", "Scroll rows"),
            (
                "e / E / J",
                "Export row group CSV / full CSV / full NDJSON (respects selection)",
            ),
            ("[ / ]", "Jump to previous / next row group"),
            ("q / Esc", "Close popup, or close viewer"),
        ],
    ),
    (
        "Editor",
        &[
            ...
            ("Ctrl+Shift+Home / Up", "Select to top of file"),
            ("Ctrl+Shift+End / Down", "Select to bottom of file"),
            ("Ctrl+A", "Select all"),
            ("Ctrl+C", "Copy selection to clipboard"),
            ("Ctrl+Z", "Undo"),
            ("Ctrl+Shift+Z", "Redo"),
